...
<%--        <p><a class="manager" href="/admin/allUsers"><fmt:message key="locale.allUsers">All users</fmt:message></a></p>--%>
        <p><a class="manager" href="${pageContext.request.contextPath}/admin/addDish"><fmt:message key="locale.add">Add dish</fmt:message></a></p>
        <p><a class="manager" href="${pageContext.request.contextPath}/admin/showAllOrders"><fmt:message key="locale.orders">All orders</fmt:message></a></p>
    </c:if>
